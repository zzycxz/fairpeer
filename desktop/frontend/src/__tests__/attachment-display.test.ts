...
const named = parseAttachmentRefsForDisplay(
  "review @[DS30000.sl2](.fairpeer/attachments/clipboard-20260610-121238.444775-000002.sl2) and @[park.png](.fairpeer/attachments/clipboard-20260610-121238.444775-000001.png)",
);
...
eq(
  ...
  [
    {
      path: ".fairpeer/attachments/clipboard-20260610-121238.444775-000002.sl2",
      name: "DS30000.sl2",
      kind: "file",
      ext: "SL2",
    },
    {
      path: ".fairpeer/attachments/clipboard-20260610-121238.444775-000001.png",
      name: "park.png",
      kind: "image",
      ext: "PNG",
    },
...
eq(
  replaceAttachmentRefsForDisplay("see @[DS30000.sl2](.fairpeer/attachments/clipboard-20260610-121238.444775-000002.sl2)"),
