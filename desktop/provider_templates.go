...
var providerTemplates = []ProviderTemplate{
	// ── Direct vendors (11) ──────────────────────────────────────────────
	{
		...
		BaseURL: "https://dashscope.aliyuncs.com/compatible-mode/v1", APIKeyEnv: "QWEN_API_KEY",
		DefaultModel: "qwen3.7-max", FastModel: "qwen3.6-flash", VisionModel: "qwen3.7-plus",
	...
	},
	{
		...
		DefaultModel: "glm-5.2", FastModel: "glm-4.7-flash", VisionModel: "glm-5v-turbo",
		Vision: true, ContextWindow: 1000000, Category: "direct",
		DocURL: "https://open.bigmodel.cn/usercenter/apikeys",
		Models: []string{"glm-5.2", "glm-5v-turbo", "glm-4.7-flash"},
	},
	{
		Name: "minimax", DisplayName: "MiniMax", Kind: "openai",
		BaseURL: "https://api.minimaxi.com/v1", APIKeyEnv: "MINIMAX_API_KEY",
		DefaultModel: "minimax-m3", FastModel: "minimax-m2.5", VisionModel: "minimax-m3",
		Vision: true, ContextWindow: 1000000, Category: "direct",
