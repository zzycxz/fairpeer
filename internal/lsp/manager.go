...
func DefaultSpecs() map[string]ServerSpec {
	return map[string]ServerSpec{
		...
		"java":       {Command: "jdtls", LanguageID: "java", Extensions: []string{".java"}, InstallHint: "install eclipse.jdt.ls: brew install jdtls / scoop jdtls / or download from eclipse.jdt.ls releases"},
		...
		"zig":        {Command: "zls", LanguageID: "zig", Extensions: []string{".zig"}, InstallHint: "install zls: matches your zig version — zig build / package managers / zls releases"},
		"kotlin":     {Command: "kotlin-language-server", LanguageID: "kotlin", Extensions: []string{".kt", ".kts"}, InstallHint: "install kotlin-language-server: brew install kotlin-language-server / scoop install kotlin-language-server / or release jar from kotlin-language-server GitHub"},
