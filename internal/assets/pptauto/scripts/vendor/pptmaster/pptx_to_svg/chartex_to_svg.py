...
from svg_to_pptx_lib.native_objects.chart_data import validate_chart_payload
from svg_to_pptx_lib.native_objects.marker_common import CHART_COLOR_STYLE_REL_TYPE
