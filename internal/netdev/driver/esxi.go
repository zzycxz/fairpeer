...
var esxiTables = classTables{
	...
	write: []string{
		...
		"esxcli system syslog", "esxcfg-vswitch -a", "esxcfg-vswitch -A", "esxcfg-vswitch -L",
		"esxcfg-vswitch -M", "esxcfg-vswitch -D", "esxcfg-vswitch -Q", "esxcfg-vmknic",
		"esxcfg-route", "esxcfg-nics", "vim-cmd vmsvc", "vim-cmd hostsvc", "vim-cmd solo/registervm",
	...
	read: []string{
		...
		"esxcfg-rescan -h", "esxcfg-mpath -l", "esxcfg-vswitch",
