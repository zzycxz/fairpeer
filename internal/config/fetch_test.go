...
func TestBuildModelFetchURLs(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: []string{"https://api.example.com/models", "https://api.example.com/v1/models"},
		},
		{
		...
		},
		{
			name:     "override wins",
			base:     "https://api.example.com",
			override: "https://api.example.com/custom/models",
			want:     []string{"https://api.example.com/custom/models"},
		},
	}
