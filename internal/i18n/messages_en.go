...
var English = Messages{
	...
	ProviderErrGatewayTransient: "Gateway drop (HTTP 400): the model gateway lost its upstream connection mid-request; your request was fine. Retried with backoff — resend if it still fails.",
